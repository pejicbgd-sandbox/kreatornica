...
<html lang="en">
  ...
  <!--[if IE]><meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"><![endif]-->
	...
	<!-----IMAGE UPLOAD JQUERY------->
	<!-- Generic page styles -->
	<link rel="stylesheet" href="file-upload-9.11.2/css/style.css">
	<!-- blueimp Gallery styles -->
	<link rel="stylesheet" href="//blueimp.github.io/Gallery/css/blueimp-gallery.min.css">
	<!-- CSS to style the file input field as button and adjust the Bootstrap progress bars -->
	<link rel="stylesheet" href="file-upload-9.11.2/css/jquery.fileupload.css">
	<link rel="stylesheet" href="file-upload-9.11.2/css/jquery.fileupload-ui.css">
	<!-- CSS adjustments for browsers with JavaScript disabled -->
	<noscript><link rel="stylesheet" href="file-upload-9.11.2/css/jquery.fileupload-noscript.css"></noscript>
	<noscript><link rel="stylesheet" href="file-upload-9.11.2/css/jquery.fileupload-ui-noscript.css"></noscript>
 ...
 <!----------------------------- user login dropdown start---------------------------------------------->
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li>
                                <a href="#"><i class="icon_mail_alt"></i> Prijemno sanduče</a>
                            </li>
                            <li>
      ...
      <section id="main-content">
          <section class="wrapper">            
			  ...
			  $pages = array ('home-admin', 'about-admin', 'member-admin', 'project-admin', 'gallery-admin', 'contact-admin', 'footer-admin');
				 ...
				 if(isset($_GET['page']) === true && in_array($_GET['page'], $pages) === true){
					 include 'include-page/' . $_GET['page'] . '.php';					 
				 } else if(!isset($_GET['page'])){
					 include 'include-page/home-admin.php';
				 }
			  ?>
